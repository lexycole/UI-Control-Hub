const Menu = [
...

  {
...

	{
		...
		children: [
			...
			{ path: "/user/freelancers", title: "Freelancers" },
			{ path: "/user/freelancers/new", title: "Add Freelancer" },			
			{ path: "/user/operators", title: "Operators" },
			{ path: "/user/operators/new", title: "Add Operator" },			
			{ path: "/clinic/users", title: "Users" },
			{ path: "/clinic/users/new", title: "Add User" },
...

  {
    ...
    title: "Garages",
    children: [
      { path: "/garage/garagesolos", title: "Garages" },
      { path: "/garage/garagesolos/new", title: "Add garage" },
      ...
      { path: "/garage/carbrands", title: "carbrands" },
      { path: "/garage/carbrands/new", title: "Add Carbrand" },
  ...
  {
    path: "/labels",
    icon: "fas fa-barcode text-orchid",
    title: "Labels",
    children: [
      { path: "/label/labels", title: "Labels" },
      { path: "/label/labels/new", title: "add Label" },
    ],
  },
