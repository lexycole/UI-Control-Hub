...
const tabMenus = [
  { label: "Assets", background: "#66ff8f" },
  { label: "Liabilities", background: "#cfcfcf" },
  { label: "Equities", background: "#ff8282" },
  { label: "Revenue", background: "#575757" },
  { label: "Expenses", background: "red" },
  { label: "Balance Sheet", background: "#66ff8f" },
  { label: "Cost of Goods Sold", background: "yellow" },
];
...
class UserTableData extends Component {
  ...
  handleCheckboxAll = () => {
    // if (this.state.checkedFields.length === this.state.allUsers.length) {
    //   this.setState({
    //     checkedFields: [],
    //   });
    // } else {
    //   let au = [];
    //   this.state.allUsers.map((u) => au.push(u._id));
    //   console.log(au);
    //   this.setState({
    //     checkedFields: au,
    //   });
              ...
              >
                ...
                <DropdownMenu>
                  ...
                  <DropdownItem onClick={this.exportPdf}>
                      <img style={iconStyles} src={pdfIcon} />PDF
                       </DropdownItem>
                </DropdownMenu>
              </Dropdown>
              <button
