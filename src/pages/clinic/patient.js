	...
	async populateUser() { 
		try {
		  ...
		  const patient = user[0];
           //console.log(patient);
			if(patient.dateBirth)patient.dateBirth = moment(patient.dateBirth).format("YYYY-MM-DD");
			else patient.dateBirth = new Date(); 
			...
			// patient.height = patient.physicalCondition.height;
			// patient.weight = patient.physicalCondition.weight;			 
							...
							<Panel>
								...
								<PanelBody className="panel-form">
									<form className="form-horizontal form-bordered" onSubmit={this.handleSubmit} >
										...
										<div className="form-group row">
											<label className="col-lg-4 col-form-label" htmlFor="primInsuranceValidTill" >Prim Insurance Valid Till</label>																				
											<div className="col-lg-8">
												<DatePicker
													onChange={this.primInsuranceTillChange}
										...
										<div className="form-group row">
											<label className="col-lg-4 col-form-label" htmlFor="secInsuranceValidTill" >Sec Insurance Valid Till</label>																				
											<div className="col-lg-8">
												<DatePicker
													onChange={this.secInsuranceTillChange}
