	...
	async populateUser() { 
		try {
		  ...
		  const { data: user } = await getAccountant(userId);
			...
			//if (accountant.dateBirth) accountant.dateBirth = new Date(accountant.dateBirth);
      if(accountant.dateBirth)accountant.dateBirth = moment(new Date(accountant.dateBirth)).format("YYYY-MM-DD");
		  else accountant.dateBirth = new Date();
...
schema = Joi.object({
		...
		accountingRegisterNo: Joi.any().optional(),		
	...
	mapToViewModel(user) {
		return {
		    ...
		    accountingRegisterNo: user.accountingRegisterNo,					
							...
							<Panel>
								...
								<PanelBody className="panel-form">
									<form className="form-horizontal form-bordered" onSubmit={this.handleSubmit} >
                                        ...
                                        {this.renderInput("Accounting-regiter-No","accountingRegisterNo","text","Enter accountingRegisterNo")}                         										
