...
class SalonSolo extends Form {
	...
	async populateUser() { 
		try {
		  ...
		  //console.log(user[0]);
             //const salon = Object.assign({},user[0]);
			 const salon = user[0];
			 //console.log(salon);
			 if(!salon.dateBirth) salon.dateBirth = new Date();
			 ...
			 salon.licenseValidTill = salon.professionalInfo.licenseValidTill;
			...
			<React.Fragment>
				<div>
					<ol className="breadcrumb float-xl-right">
						...
						<li className="breadcrumb-item"><Link to="/form/plugins">Salons</Link></li>
								 ...
								 <div className="form-group row">
										...
										<div className="btn-group col-lg-8">
											<div className="custom-control custom-radio custom-control-inline">
												<input type="radio" name="subscription" id="customRadioInline1" className="custom-control-input"  onChange={this.handleChange} value="Salon"  checked={data.subscription === "Salon" } />
												<label className="custom-control-label" htmlFor="customRadioInline1"> Salon</label>
											</div>
											<div className="custom-control custom-radio custom-control-inline">
