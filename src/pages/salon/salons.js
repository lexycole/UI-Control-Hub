         ...
         <React.Fragment>
           <ToastContainer />
						<div className="toolbar" style={toolbarStyles}>
							<button className="btn btn-default active m-r-5 m-b-5" title="add Salon" style={btnStyles}>
								{" "}
								<Link to="/salon/salons/new">
									<img style={iconStyles} src={newIcon} />
								</Link>
							</button>
							
							<button className="btn btn-default active m-r-5 m-b-5" title="edit Salon" style={btnStyles}>
								{" "}
								<Link
									to={
										this.state.checkedsalons
											? `/salon/salons/${this.state.checkedsalons[0]}`
											: "//salons/"
									}
								>
							...
							<button
								className="btn btn-default active m-r-5 m-b-5" title="delete salon" style={btnStyles}
