...
import SalonsolosTable from "../../components/salonsTable";
...
class SalonSoloTableData extends Component {
  constructor(props) {
    super(props);
    this.state = {
      users: [],
    ...
    return (
      <div>
        <ol className="breadcrumb float-xl-right">
          ...
          <li className="breadcrumb-item active">SalonSolos Table</li>
        </ol>
        <h1 className="page-header">SalonSolos </h1>
        <Panel>
          <PanelHeader>SalonSolos Management</PanelHeader>

          <React.Fragment>
            <ToastContainer />
            <div className="toolbar" style={toolbarStyles}>
              <Icon
                to="/salon/salonsolos/new"
                title="add salon"
                btnStyle={btnStyles}
              ...
              <Icon
                to={
                  checkedFields
                    ? `/salon/salonsolos/${checkedFields[0]}`
                    : "/salon/salonsolos/"
                }
                title="edit salon"
                btnStyle={btnStyles}
...
export default SalonSoloTableData;
