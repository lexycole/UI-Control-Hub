								 ...
								 <div className="form-group row">
										...
										<div className="btn-group col-lg-8">
											<div className="custom-control custom-radio custom-control-inline">
												<input type="radio" name="subscription" id="customRadioInline1" className="custom-control-input"  onChange={this.handleChange} value="Garage"  checked={data.subscription === "Garage" } />
												<label className="custom-control-label" htmlFor="customRadioInline1"> Garage</label>
											</div>
											<div className="custom-control custom-radio custom-control-inline">
...
export default withRouter(GarageSolo);