    ...
    <>
      <div className="d-flex align-items-center w-100 px-2 justify-content-between">
        ...
        <select
          ...
          onChange={(e) => onFilter("appointmentType", e.target.value)}
        >
          {map(appointmentTypeOptions, (item) => (
            <option value={item.value}>{item.label}</option>
          ))}
        </select>
        <select
          ...
          onChange={(e) => onFilter("sessionType", e.target.value)}
        >
          {map(sessionTypeOptions, (item) => (
            <option value={item.value}>{item.label}</option>
          ))}
        </select>
        <button
