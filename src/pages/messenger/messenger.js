          ...
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul className="breadcrumb breadcrumb-style ">
              <li className="breadcrumb-item bcrumb-2">
                <a href="/contacts/contacts" onClick="return false;">
                  Contacts
                </a>
              </li>
            ...
            <div className="body">
              <div id="plist" className="people-list">
                ...
                <div className="tab-content">
                  <div
                    id="chat_user"
                    style={{ position: "relative", maxHeight: "590px" }}
                  ...
                  >
                    <ul className="chat-list list-unstyled m-b-0 chat-scroll">
                      <li className="clearfix active">
                        ...
                        <div className="about">
                          <div className="name">Maria Smith</div>
                      ...
                      <li className="clearfix">
                        <img src="https://picsum.photos/204" alt="avatar" />
                        <div className="about">
                          <div className="name">William Smith</div>
                          <div className="status">
                            <i className="material-icons offline">&#x2022;</i>
                      ...
                      <li className="clearfix">
                        <img src="https://picsum.photos/205" alt="avatar" />
                        <div className="about">
                          <div className="name">William Smith</div>
                          <div className="status">
                            <i className="material-icons offline">&#x2022;</i>
                      ...
                      <li className="clearfix">
                        <img src="https://picsum.photos/206" alt="avatar" />
                        <div className="about">
                          <div className="name">William Smith</div>
                          <div className="status">
                            <i className="material-icons offline">&#x2022;</i>
        ...
        <div className="col-xs-12 col-sm-12 col-md-9 col-lg-9">
          <div className="card">
            <div className="chat">
              ...
              <div
                className="chat-history chat-scroll"
                id="chat-conversation"
                style={{ position: "relative", maxHeight: "55vh" }}
                // [perfectScrollbar]
              >
                <ul>
                  <li className="clearfix">
                  ...
                  <li>
                    ...
                    <div className="message my-message">
                      <p>
                        Its good. We completed almost all task assign by our
                        manager.
                      </p>
