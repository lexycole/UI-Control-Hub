    ...
    return (
      <div>
        ...
        <h1 className="page-header">
          Tabs & Accordions <small>header small text goes here...</small>
        </h1>
        {console.log("Active Tab", this.state.activeTab)}
        <div className="row">
          <div className="col-xl-6">
            <Panel>
              <PanelHeader noButton>Homeo Session</PanelHeader>
              <div
                className="rounded"
              ...
              >
                <PanelBody>
                  <div className="row">
                    ...
                    <div
                      className="col-9  bg-white pb-2 rounded"
                      ...
                      <TabContent activeTab={this.state.activeTab}>
                        <TabPane tabId="1">
                          ...
                          <p>
                            ...
                            Phasellus elementum, nibh eget adipiscing porttitor,
                            est diam sagittis orci, a ornare nisi quam elementum
                            tortor. Proin interdum ante porta est convallis
                            dapibus dictum in nibh. Aenean quis massa congue
                            metus mollis fermentum eget et tellus. Aenean
                            tincidunt, mauris ut dignissim lacinia, nisi urna
                            consectetur sapien, nec eleifend orci eros id
                            lectus.
                          </p>
                        ...
                        <TabPane tabId="3">
                          <p>
                            ...
                            Praesent tincidunt nulla ut elit vestibulum viverra.
                            Sed placerat magna eget eros accumsan elementum.
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit. Nam quis lobortis neque. Maecenas justo odio,
                            bibendum fringilla quam nec, commodo rutrum quam.
                            Donec cursus erat in lacus congue sodales. Nunc
                            bibendum id augue sit amet placerat. Quisque et quam
                            id felis tempus volutpat at at diam. Vivamus ac diam
                            turpis.Sed at lacinia augue. Nulla facilisi. Fusce
                            at erat suscipit, dapibus elit quis, luctus nulla.
                            Quisque adipiscing dui nec orci fermentum blandit.
                            Sed at lacinia augue. Nulla facilisi. Fusce at erat
                            suscipit, dapibus elit quis, luctus nulla. Quisque
                            adipiscing dui nec orci fermentum blandit.
                          </p>
                        </TabPane>
                      </TabContent>
                    </div>
            ...
            >
              <TabPane tabId="1" className="ronded bg-white">
                <h3 className="m-t-10">Nav Pills Tab 1</h3>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Integer ac dui eu felis hendrerit lobortis. Phasellus
                  elementum, nibh eget adipiscing porttitor, est diam sagittis
                  orci, a ornare nisi quam elementum tortor. Proin interdum ante
                  porta est convallis dapibus dictum in nibh. Aenean quis massa
                  congue metus mollis fermentum eget et tellus. Aenean
                  tincidunt, mauris ut dignissim lacinia, nisi urna consectetur
                  sapien, nec eleifend orci eros id lectus.
                </p>
              </TabPane>
              <TabPane tabId="2">
