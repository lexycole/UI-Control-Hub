...
class Usersa extends React.Component {
			...
			<div>
				...
				<div className="card border-0">
					<ul className="nav nav-pills nav-pills-v2 px-3">
						<li className="nav-item Active"><Link to="/user/usersa" className="nav-link active px-2">Active</Link></li>
						<li className="nav-item Archived"><Link to="/user/usersa" className="nav-link px-2">Archived</Link></li>						
						<li className="nav-item Banned"><Link to="/user/usersa" className="nav-link px-2">Banned</Link></li>
						<li className="nav-item All"><Link to="/user/usersa" className="nav-link px-2">All</Link></li>
						<li className="nav-item Deleted"><Link to="/user/trash" className="nav-link px-2"><i className="fa fa-trash fa-fw me-1 text-dark text-opacity-50" title="Wastebasket of Users"></i></Link></li>						
					</ul>
					<div className="tab-content p-3">
						<div className="tab-pane fade show active" id="allTab">
							<div className="input-group mb-3">
								<button className="btn btn-white dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Filter Users <b className="caret"></b></button>
								<div className="dropdown-menu">
									<Link to="/user/usersa"className="dropdown-item">Firstname</Link>
									<Link to="/user/usersa"className="dropdown-item">Lastname</Link>
									<Link to="/user/usersa"className="dropdown-item">Country</Link>
									<Link to="/user/usersa"className="dropdown-item">City</Link>
									<Link to="/user/usersa" className="dropdown-item">Age</Link>
									<Link to="/user/usersa" className="dropdown-item">Profile</Link>
									
									<Link to="/user/usersa"className="dropdown-item">Something else here</Link>
									<div role="separator" className="dropdown-divider"></div>
									<Link to="/user/usersa"className="dropdown-item">Separated link</Link>
								</div>
