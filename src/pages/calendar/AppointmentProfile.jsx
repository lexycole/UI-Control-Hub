...
class AppointmentProfile extends React.Component {
  constructor(props) {
    ...
    this.handleNotRegisteredUserChange =
      this.handleNotRegisteredUserChange.bind(this);
    this.handleRegisteredUserChange =
      this.handleRegisteredUserChange.bind(this);
    this.handleDateChange = this.handleDateChange.bind(this);
    this.handleCheckboxChange = this.handleCheckboxChange.bind(this);
    this.handleInvitedRegisterdUsersCheckboxChange =
      this.handleInvitedRegisterdUsersCheckboxChange.bind(this);
    this.handleInvitedNonRegisterdUsersCheckboxChange =
      this.handleInvitedNonRegisterdUsersCheckboxChange.bind(this);
    this.handleInvitedRegisteredUsersDateChange =
      this.handleInvitedRegisteredUsersDateChange.bind(this);
    this.handleInvitedNonRegisteredUsersDateChange =
      this.handleInvitedNonRegisteredUsersDateChange.bind(this);
  }
    ...
    try {
      ...
      this.setState({
        data: this.mapToViewModel({
          ...
          sharedNonregistredUsers: sharedNonUsers,
        }),
      });
      this.setState({
        selectedFile: Appointment.attachments,
      });
      ...
      if (i.registerId == "" && i.nonRegisterEmail == "") {
        ...
        if (i.registerId && i.registerId !== "") {
          if (!sharedRegistrationUsers.includes(i.registerId)) {
            ...
            if (
              !data.sharedUsers.some(
                (sharedUser) => sharedUser.userid == i.registerId
              )
            ) {
          ...
          if (!sharedNonRegistrationUsers.includes(i.nonRegisterEmail)) {
            ...
            if (
              !data.sharedNonregistredUsers.some(
                (sharedUser) => sharedUser.email == i.nonRegisterEmail
              )
            ) {
  ...
  actions = [
    ...
    { label: "Create Invoice", icon: "fa-money-bill-alt", trigger: () => {} },	
    { label: "Go to Treatment", icon: "fa-ambulance", trigger: () => {} },		
  ...
  handleDelete = (filePath) => {
    deleteAttachments(filePath, this.props.match.params.id, "appointments");
  };
                  ...
                  <ReusableTab id={5}>
                    <>
                      ...
                      <p>
                        ...
                        to use and work on are located in src/page/Appointment
                        When clicking on the subject, the “details of note” will
                        be unfold. Use class accordion. For post a note make use
                        of notecompose. c. build in button to close the detail
                        and redirect back to noteinbox
                      </p>
                    </>
                  </ReusableTab>
                </TabContent>
