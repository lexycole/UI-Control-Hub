              ...
              <div className="row" key={index}>
                <div className="col-12 col-md-3">
                  <div className="form-group">
                    ...
                    <input
                      disabled={user.registerId && true}
                      type="email"
                      className="form-control"
                      name="nonRegistredUser"
                      value={user.nonRegisterEmail ? user.nonRegisterEmail : ""}
                      onChange={(e) =>
                        handleNotRegisteredUserChange("nonRegisterEmail", e.target.value, index)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="col-12 col-md-3">
                  <div className="form-group">
                    ...
                    <Select
                      isDisabled={user.nonRegisterEmail && true}
                      options={selectUsers}
                      placeholder={"Select user"}
                      value={user.registerId && user.registerEmail}
                      formatOptionLabel={formatSelectUsers}
                      isOptionDisabled={(option) => option.invitationSent}
                      onChange={(e) => handleRegisteredUserChange("userid", e, index)}
                    />
                  </div>
                </div>
                <div className="col-12 col-md-3">
                ...
                {index > 0 && (
                  <div className="col-12 col-md-1" style={{ display: "flex", alignItems: "center" }}>
                    <div className="form-group">
                      <button
            ...
            <div className="card pointer-cursor my-1">
              ...
              <div id="acl" className="collapse show" data-parent="#accordion">
                <div className="card-body">
                            ...
                            <FormGroup check inline>
                              <Label check>
                                <Input
                                  ...
                                  checked={user.view}
                                  onChange={(e) =>
                                    handleInvitedRegisterdUsersCheckboxChange("view", index)
                                  }
                                />
                                <strong>View</strong>
                              </Label>
                            ...
                            <FormGroup check inline>
                              <Label check>
                                <Input
                                  ...
                                  checked={user.comment}
                                  onChange={(e) =>
                                    handleInvitedRegisterdUsersCheckboxChange("comment", index)
                                  }
                                />
                                <strong>Comment</strong>
                              </Label>
                            ...
                            <FormGroup check inline>
                              <Label check>
                                <Input
                                  ...
                                  checked={user.edit}
                                  onChange={(e) =>
                                    handleInvitedRegisterdUsersCheckboxChange("edit", index)
                                  }
                                />
                                <strong>Edit</strong>
                              </Label>
                        ...
                        <div className="form-group">
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              hanldeInvitedUsersSubmit(e, "Registered", index)
                            }}
                          >
                            <i className="fa fa-trash"></i>
                          </button>
                          <button
                            className="btn btn-green btn-icon btn-circle btn-sm"
                            onClick={(e) => {
                              hanldeInvitedUsersSubmit(e, "", index)
                            }}
                          >
                            <i className="fas fa-check"></i>
                          </button>
                  ...
                  {data?.sharedNonregistredUsers?.map((user, index) => (
                    <div className="row" key={index}>
                      <div className="col-12 col-md-3">
                        <div className="form-group">
                          <label>
                            ...
                            <FormGroup check inline>
                              <Label check>
                                <Input
                                  ...
                                  checked={user.view}
                                  onChange={(e) =>
                                    handleInvitedNonRegisterdUsersCheckboxChange("view", index)
                                  }
                                />
                                <strong>View</strong>
                              </Label>
                            ...
                            <FormGroup check inline>
                              <Label check>
                                <Input
                                  ...
                                  checked={user.comment}
                                  onChange={(e) =>
                                    handleInvitedNonRegisterdUsersCheckboxChange("comment", index)
                                  }
                                />
                                <strong>Comment</strong>
                              </Label>
                            ...
                            <FormGroup check inline>
                              <Label check>
                                <Input
                                  ...
                                  checked={user.edit}
                                  onChange={(e) =>
                                    handleInvitedNonRegisterdUsersCheckboxChange("edit", index)
                                  }
                                />
                                <strong>Edit</strong>
                              </Label>
                        ...
                        <div className="form-group">
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              hanldeInvitedUsersSubmit(e, "Non Registered", index)
                            }}
                          >
                            <i className="fa fa-trash"></i>
                          </button>
